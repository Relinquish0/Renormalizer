#!/bin/bash
#SBATCH --job-name=P3HT_multiset
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=P3HT_multiset.log
#SBATCH --error=P3HT_multiset.log
...
WORK_DIR="${SLURM_SUBMIT_DIR:-/curie-home/zengjj/Renormalizer/multiset_202605/P3HT:PCBM/multiset}"
cd "${WORK_DIR}" || exit 1
