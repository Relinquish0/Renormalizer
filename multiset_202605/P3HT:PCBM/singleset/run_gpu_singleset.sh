...
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=P3HT_s32.log
#SBATCH --error=P3HT_s32.log
...
WORK_DIR="${SLURM_SUBMIT_DIR:-/curie-home/zengjj/Renormalizer/multiset_202605/P3HT:PCBM/singleset}"
cd "${WORK_DIR}" || exit 1
