#!/bin/bash
#SBATCH --job-name=P3HT_treeX_BE_m64
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --qos=normal
#SBATCH --output=P3HT_treeX_bond_entropy_m64.log
#SBATCH --error=P3HT_treeX_bond_entropy_m64.log
...
export JOB_NAME="${JOB_NAME:-p3ht_ms_ttn_treeX_bond_entropy}"
...
WORK_DIR="${WORK_DIR:-${SLURM_SUBMIT_DIR:-/curie-home/zengjj/Renormalizer/multiset_ttn/P3HT:PCBM/multiset_treeX_bond_entropy}}"
cd "${WORK_DIR}" || exit 1
