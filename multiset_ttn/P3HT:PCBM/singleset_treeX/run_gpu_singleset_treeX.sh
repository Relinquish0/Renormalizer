#!/bin/bash
#SBATCH --job-name=P3HT_ss_treeX_m64
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --qos=normal
#SBATCH --output=P3HT_singleset_treeX_m64.log
#SBATCH --error=P3HT_singleset_treeX_m64.log
...
export JOB_NAME="${JOB_NAME:-p3ht_ttns_treeX_bond_entropy}"
