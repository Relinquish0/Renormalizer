#!/bin/bash
#SBATCH --job-name=P3HT_chain_m64
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=P3HT_chain_m64.log
#SBATCH --error=P3HT_chain_m64.log
...
export JOB_NAME="${JOB_NAME:-p3ht_ms_ttn_chain}"
...
WORK_DIR="${SLURM_SUBMIT_DIR:-/curie-home/zengjj/Renormalizer/multiset_ttn/P3HT:PCBM/multiset_chain}"
cd "${WORK_DIR}" || exit 1
