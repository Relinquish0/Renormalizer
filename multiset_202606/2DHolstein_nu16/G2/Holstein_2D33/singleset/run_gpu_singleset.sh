#!/bin/bash
#SBATCH --job-name=G2_H33_2D_s1024
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4A100,4V100
#SBATCH --qos=normal
#SBATCH --output=G2_H33_2D_s1024.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_202606/2DHolstein_nu16/G2/Holstein_2D33/singleset
#SBATCH --error=G2_H33_2D_s1024.log
...
export G="2.0"
export NU_MAX="16"
export MAX_BONDDIM="${MAX_BONDDIM:-1024}"
...
export OUTPUT_XLSX="${OUTPUT_XLSX:-H33_2D_s${MAX_BONDDIM}.xlsx}"
export OUTPUT_NPZ="${OUTPUT_NPZ:-H33_2D_s${MAX_BONDDIM}.npz}"
