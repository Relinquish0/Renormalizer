#!/bin/bash
#SBATCH --job-name=G2_H99_2D_s16
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=G2_H99_2D_s16.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_202606/2DHolstein_nu16/G2/Holstein_2D99/singleset
#SBATCH --error=G2_H99_2D_s16.log
