#!/bin/bash
#SBATCH --job-name=G0.25_H55_2D_m16
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4A100,4V100
#SBATCH --qos=normal
#SBATCH --output=G0.25_H55_2D_m16.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_202606/2DHolstein_nu16/G0.25/Holstein_2D55/multiset
#SBATCH --error=G0.25_H55_2D_m16.log
