...
g = 0.5, omega0 = J = 1, chi' = 16, nu_max = 32, dt = 0.1.
...
NU_MAX = int(os.environ.get("NU_MAX", "32"))
...
OUTPUT_XLSX = os.environ.get(
    "OUTPUT_XLSX",
    f"H{NROW}{NCOL}_2D_m{MAX_BONDDIM}_nu{NU_MAX}.xlsx",
)
OUTPUT_NPZ = os.environ.get(
    "OUTPUT_NPZ",
    f"H{NROW}{NCOL}_2D_m{MAX_BONDDIM}_nu{NU_MAX}.npz",
)
