...
#SBATCH --qos=normal
#SBATCH --mem=1024G
#SBATCH --output=H99_m64_nu32.log
#SBATCH --error=H99_m64_nu32.log
...
export OUTPUT_XLSX="${OUTPUT_XLSX:-H99_2D_m${MAX_BONDDIM}_nu${NU_MAX}.xlsx}"
export OUTPUT_NPZ="${OUTPUT_NPZ:-H99_2D_m${MAX_BONDDIM}_nu${NU_MAX}.npz}"
