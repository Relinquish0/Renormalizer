#!/bin/bash
#SBATCH --job-name=H1111_2D_s16
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4A100,4V100
#SBATCH --qos=normal
#SBATCH --output=H1111_2D_s16.log
#SBATCH --error=H1111_2D_s16.log
...
export OUTPUT_XLSX="${OUTPUT_XLSX:-H1111_2D_s${MAX_BONDDIM}.xlsx}"
export OUTPUT_NPZ="${OUTPUT_NPZ:-H1111_2D_s${MAX_BONDDIM}.npz}"
