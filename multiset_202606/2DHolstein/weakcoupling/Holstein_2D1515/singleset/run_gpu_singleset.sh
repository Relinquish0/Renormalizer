#!/bin/bash
#SBATCH --job-name=H1515_2D_s16
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4A100,4V100
#SBATCH --qos=normal
#SBATCH --output=H1515_2D_s16.log
#SBATCH --error=H1515_2D_s16.log
...
WORKDIR="/curie-home/zengjj/Renormalizer/multiset_202606/Holstein_2D1515/singleset"
cd "${WORKDIR}" || exit 1
