#!/bin/bash
#SBATCH --job-name=Trimer_abs_m32
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=Trimer_abs_m32.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_spectra/pbi_ft/trimer/abs/multiset
#SBATCH --error=Trimer_abs_m32.log
...
echo "OUTPUT_NPZ=Trimer_abs_m${MAX_BONDDIM}.npz"
echo "==============================="
