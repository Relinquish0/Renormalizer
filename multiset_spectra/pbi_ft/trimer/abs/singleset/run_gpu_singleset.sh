#!/bin/bash
#SBATCH --job-name=Trimer_abs_s32
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=Trimer_abs_s32.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_spectra/pbi_ft/trimer/abs/singleset
#SBATCH --error=Trimer_abs_s32.log
...
echo "OUTPUT_NPZ=Trimer_abs_s${MAX_BONDDIM}.npz"
echo "==============================="
