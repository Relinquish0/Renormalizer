#!/bin/bash
#SBATCH --job-name=Hexamer_emi_m32
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=Hexamer_emi_m32.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_spectra/pbi_ft/hexamer/emi/multiset
#SBATCH --error=Hexamer_emi_m32.log
...
echo "OUTPUT_NPZ=Hexamer_emi_m${MAX_BONDDIM}.npz"
echo "==============================="
