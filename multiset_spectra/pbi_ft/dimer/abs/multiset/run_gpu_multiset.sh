#!/bin/bash
#SBATCH --job-name=Dimer_abs_m32
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=Dimer_abs_m32.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_spectra/pbi_ft/dimer/abs/multiset
#SBATCH --error=Dimer_abs_m32.log
...
echo "OUTPUT_NPZ=Dimer_abs_m${MAX_BONDDIM}.npz"
echo "==============================="
