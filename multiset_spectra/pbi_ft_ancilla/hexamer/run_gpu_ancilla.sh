#!/bin/bash
#SBATCH --job-name=Hexamer_emi_ma32
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=Hexamer_emi_ma32.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_spectra/pbi_ft_ancilla/hexamer
#SBATCH --error=Hexamer_emi_ma32.log
...
echo "OUTPUT_NPZ=Hexamer_emi_ma${MAX_BONDDIM}.npz"
echo "==============================="
