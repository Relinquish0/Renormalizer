#!/bin/bash
#SBATCH --job-name=Dimer_emi_ma32
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus-per-node=1
#SBATCH -p 4V100
#SBATCH --qos=normal
#SBATCH --output=Dimer_emi_ma32.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_spectra/pbi_ft_ancilla/dimer
#SBATCH --error=Dimer_emi_ma32.log
...
echo "OUTPUT_NPZ=Dimer_emi_ma${MAX_BONDDIM}.npz"
echo "==============================="
