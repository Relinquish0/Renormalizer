...
#SBATCH -p 4A100
#SBATCH --qos=normal
#SBATCH --output=H1515_m16.log
#SBATCH --chdir=/curie-home/zengjj/Renormalizer/multiset_202607/2DHolstein1515_speed/multiset
#SBATCH --error=H1515_m16.log
...
export N_SNAPSHOTS="${N_SNAPSHOTS:-101}"
export IF_STARTUP_SUBSTEPS="${IF_STARTUP_SUBSTEPS:-0}"
export STARTUP_SUBSTEPS_N="${STARTUP_SUBSTEPS_N:-10}"
export OUTPUT_XLSX="${OUTPUT_XLSX:-H1515_2D_m${MAX_BONDDIM}_speed.xlsx}"
export OUTPUT_NPZ="${OUTPUT_NPZ:-H1515_2D_m${MAX_BONDDIM}_speed.npz}"
