...
evolve_config = EvolveConfig(EvolveMethod.tdvp_ps2, adaptive=False)  
compress_config = CompressConfig(CompressCriteria.fixed, max_bonddim=32)  

spectra = SpectraOneWayPropZeroT(  
...
save_zerot_data(filename="pbi_{}_zt_{}_{}bd.npz".format(type_,spectra.spectratype,compress_config.bond_dim_max_value))
